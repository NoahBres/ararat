...
see ``notes/plans/hometools-api.md`` section 6.1. When FDA is missing, every
...
_FDA_HELP = (
    ...
    "hometools. Grant it in System Settings > Privacy & Security > Full Disk "
    "Access -- add the exact uv-managed python3.12 binary (find it with "
    "`uv python find 3.12` inside hometools/), then restart-hometools. See "
    "notes/plans/hometools-api.md section 6.1 for the full procedure."
)
