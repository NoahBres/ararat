...
Backed by `hometools.lib.imessage_db` (chat.db reading) and
`hometools.lib.contacts` (fuzzy name -> phone/email resolution, and the
reverse for annotating senders). See notes/plans/hometools-api.md section 6
...
from hometools.lib import contacts, imessage_db
